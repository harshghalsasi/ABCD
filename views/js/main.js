...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        ...
        var sel = document.getElementsByClassName("randomPizzaContainer");
        for (var i = 0; i < sel.length; i++) {
            sel[i].style.width = newwidth + "%";
        }
    }
...
var pizzasDiv = document.getElementById("randomPizzas");              //declared pizzasDiv outside the loop
var fragment = document.createDocumentFragment();                     //Used fragment to append all pizzas at once
...
function updatePositions() {
    ...
    var items = document.getElementsByClassName('mover');             // Used getElementsByClassName instead querySelectorAll
    var scrollTp = document.documentElement.scrollTop / 1250;         // declared outside loop to reduce DOM access
    var phase;
    for (var i = 0; i < items.length; i++) {
        phase = Math.sin((scrollTp) + (i % 5));                       // declared phase variable outside for loop.
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var elem;                                                                 // declared elem vriable outside for loop.
    var appender = document.getElementById("movingPizzas1");
    for (var i = 0; i < Pizzas; i++) {                                        // reduced the no. of pizzas in the background
